...
public class AgentInput : MonoBehaviour, IAgentInput
{
    ...
    private bool fireButtonDown = false; //현재 총알발사 버튼이 눌림 상태인지

    public UnityEvent OnRealoadBtnPress;
    ...
    private void GetFireInput()
    {
        ...
        {
            if(fireButtonDown == false) //처음으로 버튼이 눌린거면 눌렸음을 통지
            {
                fireButtonDown = true;
        ...
        {
            if(fireButtonDown == true)  //버튼을 땠는데 기존에 눌려있던거라면
            {
